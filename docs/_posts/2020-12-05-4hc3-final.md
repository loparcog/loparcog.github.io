...
- **Design Thinking**: Prominent design thinking process used in UX/UI
    ...
    - **2. Define** the user's needs/problems
        ...
        - **Affinity mapping** can also be used, saturating a space with post-it notes and grouping based on relatedness, helps to process and synthesize empathy stage data
...
- These four phases overlap with the five phases of design thinking, difference not well defined though
    - Main thing is design thinking emphasizes empathy, problem definition, and ideation, while this is a more general creative problem solving process, more geared towards traditional engineering of an interface
