...
- Observations
    ...
    - Two complex poles at $\sigma_d \pm j \omega_n : = \lt \zeta \lt 1$ **(underdamped)**
...
Stability Range in Z-Plane and Maaping from s-Plane to z-Plane
...
Approximation of Continuous Control System to Discrete System

Implement a Discrete Controller from Z-Transform